...
\setthesisinfo{
	...
	Advisor={Сергій Миколайович Копичко},
...
\abstract[ukr]{
	General={Дисертацію виконано на \total{page} аркушах, вона містить \total{appendnum} додатки та перелік посилань на використані джерела з 52 найменувань. У роботі наведено \total{figures} рисунки та \total{tables} таблицю.},
...
\abstract[eng]{
	General={The thesis is presented in 32 pages. It contains 3 appendixes and bibliography of 52 references. Two figures and 1 table are given in the thesis.},
